...
{
       0,     0,     3,     5,     9,    11,    12,    16,    18,    20,
      22,    24,    26,    28,    32,    35,    38,    39,    47,    48,
      52,    53,    54,    55,    56,    65,    69,    73,    76,    80,
      84,    86,    88,    90,    92,    94,    96,   100,   104,   108,
     112,   116,   119,   122,   126,   128
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      32,     0,    -1,    33,    -1,    11,    34,     8,    -1,    35,
      -1,    -1,    35,    27,    36,    -1,    36,    -1,    37,    -1,
      38,    -1,    39,    -1,    40,    -1,    44,    -1,    29,     4,
      50,    -1,    25,    29,    -1,    24,    29,    -1,    -1,    13,
      48,    41,     5,    35,    42,     8,    -1,    -1,     7,    43,
      35,    -1,    -1,    -1,    -1,    -1,    28,    45,    48,    46,
       5,    35,    47,     8,    -1,    48,    22,    48,    -1,    48,
       3,    48,    -1,    21,    48,    -1,    14,    48,    26,    -1,
      50,    49,    50,    -1,     9,    -1,    15,    -1,    16,    -1,
      10,    -1,    12,    -1,    20,    -1,    50,    23,    50,    -1,
      50,    17,    50,    -1,    50,    19,    50,    -1,    50,     6,
      50,    -1,    50,    18,    50,    -1,    17,    50,    -1,    23,
      50,    -1,    14,    50,    26,    -1,    29,    -1,    30,    -1
};
...
{
  "$end", "error", "$undefined", "AND", "ASSIGN", "COLON", "DIV", "ELSE",
  "END", "EQ", "GE", "GLOBAL", "GT", "IF", "LEFT_PAREN", "LE", "LT",
  "MINUS", "MOD", "MULT", "NE", "NOT", "OR", "PLUS", "PRINT", "READ",
  "RIGHT_PAREN", "SEMICOLON", "WHILE", "ID", "INT_CONST", "$accept", "S",
  "prog", "stmtListO", "stmtList", "stmt", "assignmentStmt", "readStmt",
  "printStmt", "ifStmt", "$@1", "elsePart", "$@2", "whileStmt", "$@3",
  "$@4", "$@5", "bExp", "relOP", "exp", YY_NULL
};
#endif
...
#line 117 ".\\3AC.y"
    {
                new_variable();
                fprintf(outfile, " %s = %s or %s\n", variable, (yyvsp[(1) - (3)].val), (yyvsp[(3) - (3)].val));
...
#line 137 ".\\3AC.y"
    {
                new_variable();
                fprintf(outfile, " %s = %s %s %s\n", variable, (yyvsp[(1) - (3)].val), (yyvsp[(2) - (3)].val), (yyvsp[(3) - (3)].val));
                strcpy((yyval.val), variable);
            }
    break;
