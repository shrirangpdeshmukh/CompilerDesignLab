...
#line 39 ".\\AST.y"
  {
    node *PlusNode = createNode(1, 0, (yyvsp[(1) - (3)].Node), (yyvsp[(3) - (3)].Node));
    (yyval.Node) = PlusNode;
  }
  break;
...
#line 40 ".\\AST.y"
  {
    node *MinusNode = createNode(1, 1, (yyvsp[(1) - (3)].Node), (yyvsp[(3) - (3)].Node));
...
#line 43 ".\\AST.y"
  {
    node *MulNode = createNode(1, 2, (yyvsp[(1) - (3)].Node), (yyvsp[(3) - (3)].Node));
    (yyval.Node) = MulNode;
  }
  break;
...
#line 64 ".\\AST.y"
  {
    node *NumNode = createNode(0, (yyvsp[(1) - (1)].Value), NULL, NULL);
    (yyval.Node) = NumNode;
  }
  break;
