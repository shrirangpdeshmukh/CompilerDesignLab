...
/* Line 1792 of yacc.c  */
#line 39 "AST.y"
    { node *PlusNode = createNode(1, 0, (yyvsp[(1) - (3)].Node), (yyvsp[(3) - (3)].Node)); (yyval.Node) = PlusNode; }
    break;

  case 4:
/* Line 1792 of yacc.c  */
#line 40 "AST.y"
    { node *MinusNode  = createNode(1, 1, (yyvsp[(1) - (3)].Node), (yyvsp[(3) - (3)].Node)); (yyval.Node) = MinusNode; }
    break;
...
/* Line 1792 of yacc.c  */
#line 43 "AST.y"
    { node *MulNode = createNode(1, 2, (yyvsp[(1) - (3)].Node), (yyvsp[(3) - (3)].Node)); (yyval.Node) = MulNode; }
    break;
...
#line 44 "AST.y"
    {
            ...
            node *DivNode = createNode(1, 3, (yyvsp[(1) - (3)].Node), (yyvsp[(3) - (3)].Node));
            (yyval.Node) = DivNode;  
         }
    break;
...
#line 53 "AST.y"
    {
            ...
            node *ModNode = createNode(1, 4, (yyvsp[(1) - (3)].Node), (yyvsp[(3) - (3)].Node));
	        (yyval.Node) = ModNode;
         }
    break;
...
/* Line 1792 of yacc.c  */
#line 64 "AST.y"
    { node *NumNode = createNode(0, (yyvsp[(1) - (1)].Value), NULL, NULL); (yyval.Node) = NumNode; }
    break;
