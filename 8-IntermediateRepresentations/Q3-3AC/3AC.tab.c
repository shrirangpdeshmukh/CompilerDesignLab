...
static const yytype_int8 yyrhs[] =
    {
        13, 0, -1, 14, -1, 14, 5, 15, -1, 14,
        6, 15, -1, 15, -1, 15, 7, 16, -1, 15,
        8, 16, -1, 15, 9, 16, -1, 16, -1, 3,
        -1, 4, -1, 10, 14, 11, -1};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
    {
        0, 36, 36, 42, 47, 52, 54, 59, 64, 69,
        71, 72, 73};
#endif
...
static const yytype_uint8 yytable[] =
    {
        1, 2, 9, 10, 11, 10, 11, 3, 8, 15,
        12, 13, 14, 18, 19, 20, 16, 17};
...
#line 42 ".\\3AC.y"
  {
    char AddCode = addToTable((yyvsp[(1) - (3)].Value), '+', (yyvsp[(3) - (3)].Value));
    (yyval.Value) = AddCode;
  }
  break;
...
#line 47 ".\\3AC.y"
  {
    char MinusCode = addToTable((yyvsp[(1) - (3)].Value), '-', (yyvsp[(3) - (3)].Value));
    (yyval.Value) = MinusCode;
  }
  break;
...
#line 54 ".\\3AC.y"
  {
    char MulCode = addToTable((yyvsp[(1) - (3)].Value), '*', (yyvsp[(3) - (3)].Value));
    (yyval.Value) = MulCode;
  }
  break;
...
#line 59 ".\\3AC.y"
  {
    char DivCode = addToTable((yyvsp[(1) - (3)].Value), '/', (yyvsp[(3) - (3)].Value));
    (yyval.Value) = DivCode;
  }
  break;
...
#line 64 ".\\3AC.y"
  {
    char ModCode = addToTable((yyvsp[(1) - (3)].Value), '%', (yyvsp[(3) - (3)].Value));
    (yyval.Value) = ModCode;
  }
  break;
